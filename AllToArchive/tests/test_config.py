...
class TestPomConfig(unittest.TestCase):
    ...
    def test_default_config(self):
        ...
        self.assertIn("named_pmarks", config.get(""))
    ...
    def test_load_from_file(self):
        ...
        try:
            ...
            config = PomConfig()
            config.update_config_from_file(file_path)
    ...
    def test_get_class_metadata(self):
        ...
        # Test getting class metadata
        class_metadata = config.get_external_class_metadata("TestClass")
        self.assertIn("fields", class_metadata)

        # Test getting field metadata
        field_metadata = config.get_external_field_metadata("TestClass", "test_field")
    ...
    def test_load_format(self):
        ...
        with tempfile.NamedTemporaryFile(
            mode="w", delete=False, suffix="_format.yaml"
        ) as f:
            f.write(
                """
            test_section:
        ...
        try:
            ...
            # Load format
            config.upate_config_with_format(format_name)
