...
- [FlickrNavigator\setup.py](#flickrnavigatorsetuppy)
...
```
# .gitignore_special.txt for FMKProjects (root)
# Main project directory controls for git submodules
/FMKUtilities/
/FMKSpreads/
/PhotoBasics/
/FlickrNavigator/
...
```
# .gitignore_special for FMKSpreads
...
```
# .gitignore_special for FlickrNavigator and GPhotosNavigator
...
```
# .gitignore_special.txt for PhotoBasics and PhotoManager
# Test and temporary image files
/test_images/*.jpg
/test_images/*.png
/test_images/*.gif
!/test_images/sample_*.jpg  # Keep sample test images
/temp_thumbs/
/temp_images/
...
```
### ProjectTemplate/.env.j2 ###
# Environment variables for {{ display_name }}
PYTHONPATH=.
PROJECT_NAME={{ name }}
```
...
```
###  {{ Project }}/.gitignore_special.txt  - derived from ProjectTemplate/.gitignore_special.txt ###
# Project-specific files to ignore
# This template is generic - specific patterns will be
# defined in project_facts/[project].yaml
...
```
{
	"folders": [
		...
		{
			"path": "FlickrNavigator"
		},
		{
			"path": "GPhotosNavigator"
		},
		{
			"path": "PhotoManager"
		},
		{
			"path": "LiterateDataModels"
		}
	],
	"settings": {}
}
...
```
### ProjectTemplate/.env.j2 ###
# Environment variables for AI Document Manager
PYTHONPATH=.
PROJECT_NAME=ai_document_mgr
```
...
```
[submodule "FMKUtilities"]
	path = FMKUtitlities
	url = https://github.com/fredmkatz/FMKUtitlities
[submodule "FMKSpreads"]
	path = FMKSpreads
	url = https://github.com/fredmkatz/FMKSpreads
[submodule "PhotoBasics"]
	path = PhotoBasics
	url = https://github.com/fredmkatz/PhotoBasics
[submodule "FlickrNavigator"]
	path = FlickrNavigator
	url = https://github.com/fredmkatz/FlickrNavigator
[submodule "GPhotosNavigator/"]
	path = GPhotosNavigator
	url = https://github.com/fredmkatz/GPhotosNavigator
[submodule "PhotoManager"]
	path = PhotoManager
	url = https://github.com/fredmkatz/PhotoManager
[submodule "LiterateDataModels"]
	path = LiterateDataModels
	url = https://github.com/fredmkatz/LiterateDataModels
...
```
### ProjectTemplate/netlify.toml ###
[build]
  publish = "site"

# No build command needed as we're publishing pre-built files
```
...
```
# Project Facts for AI Document Manager
name: "ai_document_mgr"               # Snake case for Python package
display_name: "AI Document Manager"    # Human readable name
repo_name: "AIDocumentMgr"            # Repository/directory name
version: "0.1.0"
description: "Manage and process chat downloads from Claude and ChatGPT"

# Dependencies in Poetry format
dependencies:
...
```
# Project Facts for FMKUtilities
name: "fmk_utilities"               # Snake case for Python package
display_name: "FMK Utilities"       # Human readable name
repo_name: "FMKUtilities"          # Repository/directory name
version: "0.1.0"
description: "Common utilities for FMK Python projects"
...
```
# Common patterns to test across all projects
common:
  - pattern: "*.pyc"
    test_files:
      - "test.pyc"
...
```
### ProjectTemplate/mkdocs.yml.j2 ###
# mkdocs.yml
INHERIT: ../mkdocs.yml

site_name: AI Document Manager
repo_url: https://github.com/fredmkatz/AIDocumentMgr
...
```
# mkdocs.yml in FMKSpreads directory
INHERIT: ../mkdocs.yml

site_name: FMK Spreads
repo_url: https://github.com/fredmkatz/FMKSoreads
...
```
# mkdocs.yml in FMKUtilities directory
INHERIT: ../mkdocs.yml

site_name: FMK Utilities
repo_url: https://github.com/fredmkatz/FMKUtilities
...
```
# Base mkdocs.yml in FMKProjects directory
      ...
      handlers:
        python:
          ...
          options:
            ...
            implicitly_document_special_methods: true

# Nav added in project specific templates
nav:
  - 'index.md'
  - The API: "api.md"
  - Specs and Notes: 'project_notes.md'
  - Configuration Files: "fmk_configs.md"
  - The Environment: "fmk_environ.md"
  - Scripts: "fmk_scripts.md"
...
```
### ProjectTemplate/src/project_template/__init__.py.j2 ###
"""
AI Document Manager.

Manage and process chat downloads from Claude and ChatGPT
"""
...
```
"""
_summary_ FMKSpreads = test routines for creating spreadsheets for json data.
"""
...
```
"""
_summary_ fmk_spreads = routines for creating spreadsheets for json data.
"""
...
```
"""
_summary_ FMKSpreads/scripts = routines for creating spreadsheets for json data.
"""
...
```
"""
FMKUtilities module docstring here.
"""
...
```
"""
fmk_utilities module docstring here.
"""
...
```
### ProjectTemplate/docs/index.md.j2 ###
# AI Document Manager

Welcome to the AI Document Manager documentation.
...
```python
import ai_document_mgr

# Basic example will go here
```
...
```
# FMK Spreads - The Index File

This is the documentation for FMK Spreads.
...
```
# FMK Utilities - The Index File

This is the documentation for FMK Utilities.
...
[tool.poetry]
name = "ai_document_mgr"
version = "0.1.0"
description = "Manage and process chat downloads from Claude and ChatGPT"
authors = ["Fred M. Katz <fmkatz@gmail.com>"]
readme = "README.md"
...
date_parser==0.3
easyocr==1.7.1
google_api_python_client==2.143.0
...
```
### ProjectTemplate/.vscode/settings.json ###
{
    // Project-specific VS Code settings
    // These will override but not replace the common settings
...
```
"""
setup.py - now fixed not to run as mere import
Adds all project library paths to Python syspath

This, setup.py lives in the main project directory
It add all library paths to the Python syspath

In each .py file, the start should look like this..
import os
import sys

... (showing 10 of 69 lines)
```
...
setup(
    ...
    author="Fred M. Katz",
    author_email="fmkatz@gmail.com",
    description="A tool for navigating and managing Flickr photos",
...
setup(
    ...
    author="Fred M. Katz",
    author_email="fmkatz@gmail.com",
    description="A tool for navigating and managing Google Photos",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    classifiers=[
        "Programming Language :: Python :: 3",
...
setup(
    ...
    author="Fred M. Katz",
    author_email="fmkatz@gmail.com",
    description="A tool to support readable data models",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    classifiers=[
        "Programming Language :: Python :: 3",
...
setup(
    ...
    author="Fred M. Katz",
    author_email="fmkatz@gmail.com",
    description="Low level utilities for handling photos",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    classifiers=[
        "Programming Language :: Python :: 3",
...
setup(
    ...
    author="Fred M. Katz",
    author_email="fmkatz@gmail.com",
    description="A tool for navigating and managing photos across multiple hosters",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    classifiers=[
        "Programming Language :: Python :: 3",
