...
- **cardinality** - The cardinality of the relationship represented by the attribute _(CardinalityCode)_
  	...
  	***Default:***
  	- For a singular attribute, the default cardinality is N:1. If the attribute is 1:1, it must be stated explicitly.
...
- **default** - The rule or formula for calculating the value, if no value is supplied _(Derivation, optional)_  
