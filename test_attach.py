...
print("LDM class has render_markdown:", hasattr(Literate_01.LDM, "render_markdown"))

# Create a simple instance directly
test_ldm = Literate_01.LDM(name="Test")

# Check if the instance has the method
print("LDM instance has render_markdown:", hasattr(test_ldm, "render_markdown"))

# Add a method directly to the class definition
def test_render(self):
    return f"Test render for {self.name}"

Literate_01.LDM.test_render = test_render

# Create another instance
test_ldm2 = Literate_01.LDM(name="Test2")

# Check if the new instance has the method
print("Second LDM instance has test_render:", hasattr(test_ldm2, "test_render"))
