...
from ldm.Literate_01 import (Diagnostic, Annotation, DataType, BaseDataType, DataTypeClause, ClassName,
                             AttributeName, AttributeSectionName, SubjectName, IsOptional
                             )
from class_casing import UpperCamel, Casing, SnakeCase, LowerCamel
...
def testdiag():
    d = Diagnostic(severity = "Error", message = "HELLO",
               object_type = "Gopher", object_name = "Gogo")
    diagnostics = [d]
    diagnostics2 = []
